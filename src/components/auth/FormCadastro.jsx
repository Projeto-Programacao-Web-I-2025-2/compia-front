...
export default function FormCadastro() {
    return( 
        <div className='formLogin flex flex-col items-center bg-[#FFFFFF] min-w-[40vh] min-h-[55vh] rounded-4xl border-2 border-[#979797] shadow-2xl'>
            <img src={Logo} className='logo w-40 h-10 mt-7'></img>
            <div className='text-[#314C91] flex flex-col items-center mt-5 space-y-4'>
                <h1 className='font-bold text-2xl w-[25vh] text-left'>Cadastrar</h1>
