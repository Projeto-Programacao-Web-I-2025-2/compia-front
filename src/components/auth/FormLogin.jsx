...
export default function FormLogin() {
    ...
    return(
        <form className='w-[270px] h-[350px] md:w-[300px] md:h-[370px] formLogin flex flex-col items-center bg-[#FFFFFF] rounded-4xl border-2 border-[#979797] shadow-2xl' onSubmit={handleSubmit}>
            <img src={Logo} className='logo w-40 h-10 mt-7'></img>
            <div className='text-[#314C91] flex flex-col items-center mt-5 space-y-4 w-[200px] md:w-[235px]'>
                <h1 className='w-[200px] md:w-[235px] font-bold text-2xl text-left'>Entrar</h1>
                ...
                <h2 className='font-bold text-sm md-text-md'>Não tem uma conta? <Link to={'/cadastro'} className='underline hover:text-[#F174A7] cursor-pointer '>Cadastre-se</Link></h2>
            </div>
        </form>
    )
}