            ...
            <div className="flex flex-col bg-[#FFFFFF] border-[#979797] rounded-lg border-1 w-[317px] h-[400px] shadow-xl">
                ...
                <div className="flex flex-col mr-5 ml-5 mt-6">
                    ...
                    <div className="flex justify-between items-center mt-2">
                        <h2>R$ {preco}</h2>
                        <button className="flex items-center justify-center rounded-xl p-1 bg-[#5494D2] border-1 border-[#979797] hover:bg-[#31567A] text-white cursor-pointer" onClick={(e) => {e.preventDefault(); e.stopPropagation();}}>
                            Comprar
